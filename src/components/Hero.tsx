...
// Workaround for Typewriter type incompatibility with React 18+ types
...
export default function Hero() {
  return (
    <section
      id="home"
      className="min-h-screen w-full flex flex-col md:flex-row items-center justify-center px-8 md:px-20 pt-24 gap-10 overflow-hidden relative bg-black"
    >
      ...
      >
        <span className="inline-block py-1 px-3 rounded-full bg-zinc-900 border border-zinc-800 text-primary text-xs font-bold tracking-wide mb-2">
