        ...
        <footer className="bg-black py-5 sm:py-6">
            <div className="mx-auto max-w-7xl px-5 sm:px-8 md:px-16 lg:px-20">
                <div className="footer-glass rounded-3xl p-5 sm:p-6 md:p-7">
                    ...
                    <div className="mb-6 flex flex-col items-center justify-between gap-6 sm:mb-7 lg:flex-row lg:items-center lg:gap-10">
                        <div className="space-y-3 text-center sm:text-left">
                            ...
                            <p className="text-xs font-bold uppercase tracking-[0.16em] text-white sm:text-sm xl:whitespace-nowrap">
                                {t("footerTaglinePrefix")} <span className="text-primary">{t("footerTaglineHighlight")}</span>
                            </p>
                        </div>

                        <div className="flex shrink-0 items-center gap-2 rounded-full bg-black/15 p-1.5">
                            <a
                                href="https://github.com/HecthorDev"
                                target="_blank"
                                rel="noreferrer"
                                aria-label="GitHub"
                                className="flex h-10 w-10 items-center justify-center rounded-full bg-zinc-900/70 text-zinc-400 transition-all hover:!bg-primary hover:!text-black hover:[box-shadow:0_4px_15px_rgba(0,0,0,0.3)]"
                            >
